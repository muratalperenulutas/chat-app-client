...
import '../general_change_notifier.dart' as _i1044;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i174.GetIt init({
    ...
    gh.singleton<_i1044.GeneralChangeNotifier>(
        () => _i1044.GeneralChangeNotifier());
    ...
    gh.singleton<_i865.CollectivityRepository>(
        () => _i865.CollectivityRepository(
              gh<_i1049.DatabaseService>(),
              gh<_i1044.GeneralChangeNotifier>(),
            ));
    gh.singleton<_i260.MessageRepository>(() => _i260.MessageRepository(
          gh<_i1049.DatabaseService>(),
          gh<_i1044.GeneralChangeNotifier>(),
        ));
    gh.singleton<_i841.PersonRepository>(() => _i841.PersonRepository(
          gh<_i1049.DatabaseService>(),
          gh<_i1044.GeneralChangeNotifier>(),
        ));
    return this;
